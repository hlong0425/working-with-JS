...
with the goalkeeper's name, and one array ('fieldPlayers') with all the remaining 10 field players => use rest */

let [gk, ...fieldPlayers] = players2;
console.log(gk); //Burki
console.log(fieldPlayers); // ['Schulz', 'Hummels', 'Akanji', 'Hakimi', 'Weigl', 'Witsel', 'Hazard', 'Brandt', 'Sancho', 'Gotze']

//3. Create an array 'allPlayers' containing all players of both teams (22 players) => use Spread
